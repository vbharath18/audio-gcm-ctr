...
function App() {
  ...
  const [sessionData, setSessionData] = useState(null); // Ephemeral state for key and session info
  ...
  const encryptAndStore = async () => {
    ...
    // SECURE: We store the key in ephemeral React state, not sessionStorage.
    // This prevents XSS attacks from easily retrieving the key.
